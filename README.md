...
### 2. Read Mapping (`results/mapping/`)
...
### 3. Read Counting (`results/counts/`)
...
### 4. Differential Expression & GO Enrichment (`results/deseq2/`)
...
2. Grab the input files from the links in `data/links.txt` and upload them to a new Galaxy history
